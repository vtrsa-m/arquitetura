...
# Variável usada para armazenar o caminho da pasta de arquivos
...
def ler_arquivo_entrada():
    ...
    try:
        ...
        # acaba sendo ignorada, e cada instrução 
        # precisa ter 16 bits para ser válida
    ...
    try:
        ...
        with open(M_R, "w") as f:
            for i, conteudo in enumerate(cpu.ram):
                ...
                # então ele converte o conteúdo para 
                # binário apenas se for um inteiro
